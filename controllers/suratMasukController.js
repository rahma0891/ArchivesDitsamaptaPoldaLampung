...
exports.getAllSuratMasuk = handlerFactory.getAll(SuratMasuk);
...
exports.createSuratMasuk = catchAsync(async (req, res, next) => {
  ...
  stream.on('finish', async () => {
    ...
    const suratMasuk = await SuratMasuk.create({
      no,
      pengirim,
      tanggalSurat,
      tanggalDiterima,
...
exports.updateSuratMasuk = catchAsync(async (req, res, next) => {
  ...
  const suratMasuk = await SuratMasuk.findByPk(req.params.id);
...
exports.getSuratMasuk = handlerFactory.getOne(SuratMasuk);

exports.deleteAssociatedFile = catchAsync(async (req, res, next) => {
  const suratMasuk = await SuratMasuk.findByPk(req.params.id);

  const filename = suratMasuk.file_url.split('/').pop();
...
exports.deleteSuratMasuk = handlerFactory.deleteOne(SuratMasuk);
